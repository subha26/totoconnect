        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              maxLength={10}
              required
              className="text-lg placeholder:text-muted-foreground placeholder:opacity-40"
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              maxLength={4}
              required
              className="text-lg tracking-widest placeholder:text-muted-foreground placeholder:opacity-40"
            />
          </div>
